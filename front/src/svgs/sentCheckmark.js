...
function SentCheckmark({info}) {
    return (
        <svg className={`m-auto ${info ? "mt-10" : "my-5"}`} width="100px" height="100px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g id="Icon-Set-Filled" transform="translate(-102.000000, -1141.000000)" fill="#43A047">
