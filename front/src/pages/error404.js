...
function Error404() {
    return (
        <div className="section-styling h-[84vh] text-center">
            <div className="mt-20">
                <svg className="fill-white m-auto" width="100px" height="100px" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                    <g fillRule="evenodd">
                        <path d="M0 7a7 7 0 1 1 14 0A7 7 0 0 1 0 7z"/>
                        <path d="M13 7A6 6 0 1 0 1 7a6 6 0 0 0 12 0z" fill="#121212"/>
