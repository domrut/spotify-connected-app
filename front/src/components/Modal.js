...
function Modal({store}) {
    ...
    return (
        <>
            ...
            <div className="fixed w-[200px] p-3 2xs:p-0 2xs:w-[300px] z-[21] h-[400px] sm:w-[500px] rounded-md bg-sectionColor dark:bg-sectionColorLight top-[30%] left-0 right-0 m-auto translate-y-[-50%]">
                    {isDataSent ?
