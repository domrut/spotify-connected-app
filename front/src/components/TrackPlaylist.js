...
function TrackPlaylist({owner, tracks, name, type, image, description, external_urls, itemDuration}) {
    return (
        <>
            <img className="w-[200px] sm:w-[300px] rounded-md mb-5 xs:mb-0" src={image[0].url} alt=""/>
            <div className="flex flex-col justify-evenly ml-0 xs:ml-10">
                <div className="flex flex-col">
                    ...
                    <p className="text-2xs mb-2 text-neutral-400 whitespace-normal">{description}</p>
                    <div>
                ...
                <div className="flex items-center">
                    ...
                    <Link to={external_urls} target="_blank">
                        <svg className="fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50"
