        ...
        <div className="flex flex-3 flex-col justify-between section-styling">
            ...
            <div className="flex-wrap flex">
                ...
                {topArtists && topArtists.map((el, index) => {
                    return <div className="text-white top-artist-card grow shrink-0 basis-44 md:basis-36 lg:basis-52 3xl:basis-56 4xl:basis-40 p-6 bg-neutral-900 hover:bg-neutral-800 transition duration-300 ease-in m-2 rounded-lg" key={index}>
                        <img className="top-artist-image" src={el.images[el.images.length - 1].url} alt=""/>
