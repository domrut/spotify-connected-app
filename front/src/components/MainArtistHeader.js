...
function MainArtistHeader({relatedArtists, image, name, genres, followers, external_urls}) {
    return (
        <>
            <div className="text-white dark:text-black font-bold flex flex-col 1.5md:flex-row">
                <div className="section-styling mb-2 1.5md:mb-0 1.5md:mr-2 flex-2">
                    ...
                    <div className="mt-10">
                        ...
                        <div className="mb-5">
                            <p className="text-base text-neutral-200 dark:text-neutral-800 my-2">Genres</p>
                            <span className="text-md text-neutral-500">{genres.join(", ")}</span>
                        </div>
                        <div className="mb-5">
                            <p className="text-base text-neutral-200 dark:text-neutral-800 my-2">Followers</p>
                            <p className="text-md text-neutral-500">{followerFormatter(followers.total)}</p>
                        </div>
                        <div className="mb-5">
                            <p className="text-base text-neutral-200 dark:text-neutral-800 my-2">Find them on</p>
