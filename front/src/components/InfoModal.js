...
function InfoModal() {
    ...
    return (
        <>
            ...
            <div className="absolute w-[200px] p-3 2xs:p-0 2xs:w-[300px] z-[21] h-[300px] sm:w-[500px] rounded-md bg-sectionColor dark:bg-sectionColorLight top-[30%] left-0 right-0 m-auto translate-y-[-50%]">
                    <SentCheckmark info/>
